...
export function LoginPage() {
  ...
  // Redirect if already authenticated (also triggers after successful login state update)
  useEffect(() => {
    if (isAuthenticated) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-[#faf3e8] px-4">
      <div className="w-full max-w-[420px] bg-white rounded-xl p-10 shadow-[0_8px_32px_rgba(139,69,19,0.12)]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#8d6e63] m-0">Sign in to access your workspace</p>
        </div>
