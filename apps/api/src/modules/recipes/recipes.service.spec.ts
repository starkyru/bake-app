  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(RecipeImage), useValue: { create: jest.fn((d) => d), save: jest.fn((e) => Promise.resolve(e)), find: jest.fn(), delete: jest.fn(), createQueryBuilder: jest.fn() } },
